...
let events = {
  ...
  contextmenu: e =>
    Object.assign(selectionState, { mouseDown: false, mouseUp: e }),
  pointerdown: e =>
    Object.assign(selectionState, {
      pointerDown: e,
      pointerUp: false,
  ...
  keyup: e =>
    Object.assign(selectionState, { previousKey: e, currentKey: false }),
  ...
  checkConditions: function() {
    ...
    if (this.currentSelector) {
      ...
      if (isValid) {
        ...
        if (selector.onSelectionEnd) selector.onSelectionEnd(selectionState);
